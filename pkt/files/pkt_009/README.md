...
### Objective:
O objetivo desta atividade foi realizar o acesso via console aos switches para habilitar a interface VLAN e realizar a atribuição de endereçamento IP, garantindo a gestão e a conectividade dos dispositivos na rede.
