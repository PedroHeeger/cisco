...
### Objective:
Esta atividade visou a construção física de uma rede com dois switches e dois PCs, explorando o uso correto de cabeamento estruturado (Console, Ethernet e Cross-over). Após a montagem, foram aplicadas diretrizes de segurança inicial e endereçamento IP, seguidos por testes de comunicação para garantir o funcionamento do ambiente.
