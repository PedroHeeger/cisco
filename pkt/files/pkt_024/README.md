...
#### Tabela 1 — Tabela de Endereçamento MAC

| Dispositivo |   Interface   |   Endereço MAC   | Interface do Switch |
|:-----------:|:-------------:|:----------------:|:-------------------:|
| Router0     | G0/0          | 0001.6458.2501   | G0/1                |
| Router0     | S0/0/0        | N/D              | N/D                 |
| Router1     | G0/0          | 00E0.F7B1.8901   | G0/1                |
| Router1     | S0/0/0        | N/D              | N/D                 |
| 10.10.10.2  | Rede Sem Fio  | 0060.2F84.4AB6   | F0/2                |
| 10.10.10.3  | Rede Sem Fio  | 0060.4706.572B   | F0/2                |
...
- c. Clique em 172.16.31.2 e insira o comando arp –a.
  - `arp -a`.
- c. A qual endereço IP corresponde a entrada do endereço MAC?
...
A imagem 02 evidencia o processo de resolução de endereços realizado pelo protocolo ARP, no qual o endereço IP de destino é associado ao respectivo endereço físico (MAC) e armazenado na tabela ARP do PC de origem.
...
- c. Insira o comando ping 10.10.10.3. 
  - `ping 10.10.10.3`.
- c. Quantas respostas foram enviadas e recebidas?
...
- a. As entradas correspondem às da tabela acima?
...
- b. Clique em Switch0 e depois na guia CLI. Insira o comando show mac-address-table. 
  - `show mac-address-table`.
- b. As entradas correspondem às da tabela acima?
...
A imagem 03 mostra que os dois switches preencheram suas tabelas de endereços MAC com base nos quadros recebidos durante a comunicação entre os dispositivos das respectivas redes.
...
- c. Digite arp –a. 
  - `arp –a`.
- c. Qual é o endereço IP da nova entrada da tabela ARP? 
...
- b. Entre no modo EXEC privilegiado e insira o comando show mac-address-table. 
  - `enable` -> `class` -> `show mac-address-table`.
- b. Quantos endereços MAC há na tabela? Por quê?
...
- c. Insira o comando show arp. 
  - `show arp`.
- c. Existe uma entrada para 172.16.31.2?
...
A imagem 04 exibe a tabela ARP do roteador, contendo o mapeamento entre os endereços IP e os respectivos endereços físicos (MAC) dos dispositivos da rede.
