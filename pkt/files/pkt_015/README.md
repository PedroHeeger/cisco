...
### Objective:
O objetivo desta atividade foi utilizar a linguagem de programação **Blockly** para controlar LEDs de um objetos IoT a partir de unidades microcontroladoras (MCU).
